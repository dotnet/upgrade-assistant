...
namespace Microsoft.DotNet.UpgradeAssistant.DeprecatedApisAnalyzer
{
    ...
    {
        public const string AttributeDiagnosticId = "UA0106";
        public const string ConstructorCountDiagnosticId = "UA0107";
        public const string ParameterDiagnosticId = "UA0108";
        public const string ParameterCountDiagnosticId = "UA0109";
        ...
        private static readonly DiagnosticDescriptor AttributeRule = new(AttributeDiagnosticId, AdapterDescriptorTypeAttributeTitle, AdapterDescriptorTypeAttributeMessageFormat, Category, DiagnosticSeverity.Warning, isEnabledByDefault: true, description: AdapterDescriptorTypeAttributeDescription, helpLinkUri: HelpLink.Create(AttributeDiagnosticId));
        private static readonly DiagnosticDescriptor ConstructorCountRule = new(ConstructorCountDiagnosticId, AdapterDescriptorTypeConstructorCountTitle, AdapterDescriptorTypeConstructorCountMessageFormat, Category, DiagnosticSeverity.Warning, isEnabledByDefault: true, description: AdapterDescriptorTypeConstructorCountDescription, helpLinkUri: HelpLink.Create(ConstructorCountDiagnosticId));
        private static readonly DiagnosticDescriptor ParameterRule = new(ParameterDiagnosticId, AdapterDescriptorTypeParameterTitle, AdapterDescriptorTypeParameterMessageFormat, Category, DiagnosticSeverity.Warning, isEnabledByDefault: true, description: AdapterDescriptorTypeParameterDescription, helpLinkUri: HelpLink.Create(ParameterDiagnosticId));
        private static readonly DiagnosticDescriptor ParameterCountRule = new(ParameterCountDiagnosticId, AdapterDescriptorTypeParameterCountTitle, AdapterDescriptorTypeParameterCountMessageFormat, Category, DiagnosticSeverity.Warning, isEnabledByDefault: true, description: AdapterDescriptorTypeParameterCountDescription, helpLinkUri: HelpLink.Create(ParameterCountDiagnosticId));
