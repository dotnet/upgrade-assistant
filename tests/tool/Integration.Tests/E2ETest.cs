...
namespace Integration.Tests
{
    public sealed class E2ETest : IDisposable
    {
        ...
        [InlineData("MauiSample/droid", "EwDavidForms//EwDavidForms.Android//EwDavidForms.Android.csproj", "")]
        [InlineData("MauiSample/ios", "EwDavidForms//EwDavidForms.iOS//EwDavidForms.iOS.csproj", "")]
        [Theory]
